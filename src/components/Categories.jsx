        ...
        <div className="my-14 flex justify-center mb-36">
            <div className=" w-[70%]">
                ...
                <div className="flex flex-wrap justify-center gap-10 cursor-pointer">
                    <div className=" w-[20%] h-48 border-[1px] border-slate-400 flex rounded-lg flex-col gap-4 justify-center items-center hover:scale-105 hover:shadow-md hover:shadow-[#0DAFE6]">
