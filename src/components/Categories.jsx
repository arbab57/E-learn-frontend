...
const Categories = () => {
    return (
        <div className="my-14 mb-36">
            ...
            <div className="mt-[6rem] flex flex-wrap justify-center gap-20 cursor-pointer">
                <div className=" w-[15%] h-48 border-[1px] border-slate-400 flex rounded-lg flex-col gap-4 justify-center items-center hover:scale-105 hover:shadow-md hover:shadow-[#0DAFE6]">
