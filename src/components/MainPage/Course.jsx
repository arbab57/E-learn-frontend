    ...
    <div className="p-6">
      <div className="container mx-auto justify-between items-center mb-0">
        ...
        {currentCourses.map((course) => (
          ...
          >
            <button
              className="absolute top-4 right-4 bg-[#0DAFE6] text-white px-4 py-2 rounded-lg transition-all p-4"
              onClick={() =>
                onCourseSelect(course.data.details.title, course.data.details.img)
              }
            >
              Enroll Now
            </button>
