            ...
            <div className="bg-[#f2f6f8]  w-screen fixed top-0 left-0 flex flex-col justify-center h-screen">
                <div className="w-full max-w-md mx-auto p-8 bg-white rounded shadow-md">
                    ...
                    <div className="flex justify-between">
                        <button onClick={() => navigate("/forget")} className="text-sm cursor-pointer text-gray-700 mt-2 active:text-blue-400">Forget Passwrod!</button>
                        <button onClick={() => navigate("/register")} className="text-sm cursor-pointer text-gray-700 mt-2 active:text-blue-400">Register Now!</button>
                    </div>
                </div>
            </div>
        </>
