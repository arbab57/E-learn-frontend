...
const Courses = () => {
  ...
  return (
    <div>
      {loading && <Loader />}
      <div className="mb-6 px-10 flex justify-end items-center min-h-[100vh]:">
      ...
      {courses.map((course) => (
        <div key={course.id} className="bg-white shadow-lg border border-gray-300 rounded-lg p-6 font-roboto flex flex-col lg:flex-row gap-6 mb-6">
      ...
      {/* Pagination Controls */}
      <div className="flex mx-10 my-8 justify-between items-center mt-4">
        <button
